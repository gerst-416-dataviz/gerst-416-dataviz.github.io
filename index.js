...
function showIntroText() {
    ...
    centered.innerHTML = "";
    var lines = ["They just don't make movies like they used to...", "...or do they?", "Let's find out."];
    lines.forEach((e, i) => {
        var span = document.createElement("span");
        console.log("created " + i);
        span.style.transition = "all .5s";
        span.style.transitionDelay = (2 * i) + "s";
        ...
        setTimeout(function() {
            ...
            if (i == lines.length - 1) {
                setTimeout(scene1StartButtonAppear, (2 * i + 1) * 1000);
            }
        }, 10);
    });
}
